...
const displayMovieDetailsModal = (event, movie) => {
  ...
  document.getElementById('movie-poster').src = movie.poster_path ? _constants__WEBPACK_IMPORTED_MODULE_1__.moviePosterURL + movie.poster_path : 'assets/no-image.jpg';
...
const createMovieSlide = movie => {
  ...
  moviePoster.setAttribute('data-lazy', movie.poster_path ? _constants__WEBPACK_IMPORTED_MODULE_1__.movieImageURL + movie.poster_path : 'assets/no-image.jpg');
